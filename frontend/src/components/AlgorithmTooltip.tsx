...
interface Props {
  /** Forklaringsteksten som vises i popoveren. */
  text: string;
  /** Aksentfarge som matcher paneltittelen. Standard: nøytral grå. */
  color?: string;
}
  ...
  return (
    <div ref={containerRef} className="relative inline-flex items-center">
      ...
      {open && (
        <div
          role="tooltip"
          className="absolute left-0 top-7 z-50 w-72 rounded-xl border border-[#2a2a2a] bg-[#191919] p-4 shadow-2xl"
        >
          {/* Liten pil */}
          <div
            className="absolute -top-[5px] left-2.5 h-2.5 w-2.5 rotate-45 border-l border-t border-[#2a2a2a] bg-[#191919]"
          />
